...
public class ResourceServlet {
	...
	@POST
	public Response createCarPool(@QueryParam("carpoolId") String carpoolId, @FormParam("userId") String userId, @FormParam("SeatsAvailable") String seatsAvailable, @FormParam("carInfo") String carInfo, @FormParam("price") String price, @FormParam("carpoolDate") String carpoolDate, @FormParam("startCity") String startCity, @FormParam("endCity") String endCity, @FormParam("startPoint") String StartPoint, @FormParam("dropPoint") String dropPoint )
			throws Exception {
		...
		JsonObject resultObject = createCar(db,idString,carpoolId,userId,seatsAvailable,carInfo, price, carpoolDate, startCity, endCity, StartPoint, dropPoint,null,null);
	...
	public JsonObject createCar(Database db, String id, String carpoolId, String userId, String seatsAvailable,String carInfo, String price, String carpoolDate, String startCity, String endCity, String startPoint,String dropPoint, Part part, String fileName)
			throws IOException {
		...
		if (obj == null) {
			...
			System.out.println("Creating new document with id : " + carpoolId);
			Map<String, Object> data = new HashMap<String, Object>();
			data.put("userId", userId);
			data.put("_id", carpoolId);
